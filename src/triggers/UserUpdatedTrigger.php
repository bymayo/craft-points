...
class UserUpdatedTrigger extends BaseTrigger
{
    public static function handle(): string { return 'user.updated'; }
    public static function label(): string { return 'User updated'; }
